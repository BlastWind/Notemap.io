...
class GraphEditor extends Component {
  ...
  createCanvas() {
    ...
    function restart() {
      ...
      // JOIN
      circle = circle.data(that.nodes, function(d) {
        console.log(d);
        return d.id;
      });
      ...
      // UPDATE
      /*
      circle.selectAll("rect").style("fill", d =>
        d === that.selectedNode
          ? d3
              .rgb(colors(d.id))
              .brighter()
...
*/
      ...
      console.log("circle after selectall", circle.data());
      console.log("circle data", circle.data(), "circle entered");
      // add new nodes
      var g = circle
        .enter()
        .append("svg:g")
